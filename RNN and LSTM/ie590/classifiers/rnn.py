...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == 'rnn':
           h, cache_rnn = rnn_forward(x, h0, Wx, Wh, b, use_tanh = self.use_tanh)           
        else:
        ...
        if self.cell_type == 'rnn':
           dx, dh0, dWx, dWh, db = rnn_backward(dh, cache_rnn, use_tanh = self.use_tanh)
        else:
        ...
        grads = {'W_vocab':dW_vocab, 'b_vocab':db_vocab, 'Wx':dWx, 'Wh':dWh, 
                 'b':db, 'W_embed':dW_embed, 'W_proj':dW_proj, 'b_proj':db_proj} ## Write your code here
    ...
    def sample(self, features, max_length=30):
        ...
        for i in range(max_length):
            if self.cell_type == 'rnn':
               next_h, _ = rnn_step_forward(x, h0, Wx, Wh, b, use_tanh = self.use_tanh)
            else:
