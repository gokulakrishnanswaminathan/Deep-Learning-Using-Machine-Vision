...
class FourLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        X3, fc2_cache = affine_relu_forward(X2, W3, b3)
        scores, fc3_cache = affine_forward(X3, W4, b4)
        ...
        dout, grads['W4'], grads['b4'] = affine_backward(softmax_grad, fc3_cache)
        dout, grads['W3'], grads['b3'] = affine_relu_backward(dout, fc2_cache)
